function validate(){
	...
	{
		document.getElementById("pass").innerHTML = "Passwords must have at least 6 characters and contain at least the following:upper case letters, lower case letters and numbers.";
		flag=1;
	}
	if(x!=y)
	{
