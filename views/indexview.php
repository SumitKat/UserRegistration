...
<nav class = "navbar navbar-inverse">
    <div class = "container-fluid">
        ...
        <div class = "collapse navbar-collapse" id="myNavbar">
            ...
            <ul class= "nav navbar-nav">
            <li><button type="button" class="btn btn-danger" data-toggle="modal" data-target="#myModal">Show Errors</button></li>
            </ul>
            ...
            <div class = "col-lg-4">
                <div class = "address">
                    ...
                    <div class = "form-group">
                        ...
                        <input type = "text" class="form-control" name="cCity" id="c_city" value=<?php echo isset($_SESSION['form_data']['cCity']) ? $_SESSION['form_data']['cCity'] : '';?>>
                        <span class = "error">*<?php echo $currentCityErr;?></span>
                    </div>
                    <div class = "form-group">
                        <label for="c_state">Current State: </label>
                        <input type = "text" class="form-control" name="cState" id="c_state" value=<?php echo isset($_SESSION['form_data']['cState']) ? $_SESSION['form_data']['cState'] : '';?>>
                        <span class = "error">*<?php echo $currentStateErr;?></span>
                    </div>
                    <div class = "form-group">
                        <label for = "c_country">Current Country: </label>
                        <input type = "text" class="form-control" name="cCountry" id="c_country" value=<?php echo isset($_SESSION['form_data']['cCountry']) ? $_SESSION['form_data']['cCountry'] : '';?>>
                        <span class = "error">*<?php echo $currentCountryErr;?></span>
                    </div>

                    <div class = "form-group">
                        <label for = "p_street">Permanent Street:</label>
                        <input type = "text" class="form-control" name="pStreet" id="p_street" value=<?php echo isset($_SESSION['form_data']['pStreet']) ? $_SESSION['form_data']['pStreet'] : '';?>>
                        <span class = "error">*<?php echo $permanentStreetErr;?></span>
                    </div>
                    <div class = "form-group">
                        <label for = "p_city">Permanent City:</label>
                        <input type = "text" class="form-control" name="pCity" id="p_city" value=<?php echo isset($_SESSION['form_data']['pCity']) ? $_SESSION['form_data']['pCity'] : '';?>>
                        <span class = "error">*<?php echo $permanentCityErr;?></span>
                    </div>
                    <div class = "form-group">
                        <label for = "p_state">Permanent State: </label>
                        <input type = "text" class="form-control" name="pState" id="p_state" value=<?php echo isset($_SESSION['form_data']['pState']) ? $_SESSION['form_data']['pState'] : '';?>>
                        <span class = "error">*<?php echo $permanentStateErr;?></span>
                    </div>
                    <div class = "form-group">
                        <label for = "p_country">Permanent Country: </label>
                        <input type = "text" class="form-control" name="pCountry" id="p_country" value=<?php echo isset($_SESSION['form_data']['pCountry']) ? $_SESSION['form_data']['pCountry'] : '';?>>
